        ...
        <div className="bar">
            <div className="sort">
                ...
                <select value={select} onChange={e => setSelect(e.target.value)}>
                    <option value="default_sort">numatytą</option>
                    <option value="price_asc_sort">kainą nuo mažiausios</option>
                    <option value="price_desc_sort">kainą nuo didžiausios</option>
                    <option value="title_sort"> pavadinimą</option>
                </select>
            </div>
            <div className="sort">
