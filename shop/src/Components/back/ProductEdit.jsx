...
function ProductEdit() {
    ...
    const edit = () => {
        ...
        if (file) {
            getBase64(file)
                .then(photo => setEditProductData({ ...inputs, photo, price: parseFloat(inputs.price), id: modalProductData.id, delete: deletePhoto ? 1 : 0 }));
        } else {
            setEditProductData({ ...inputs, price: parseFloat(inputs.price), id: modalProductData.id, delete: deletePhoto ? 1 : 0 });
        }
        setModalProductData(null);
        setDeletePhoto(false);
    }
    //duomenims ikelti i redagavimo laukeli
    useEffect(() => {
