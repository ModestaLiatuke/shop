        ...
        <li className="list-group-item">
            <div className="product-line">
                ...
                <div className="product-line__buttons">
                    <button type="button" className="btn btn-outline-success mr-2 " onClick={() => setModalProductData(product)}>Redaguoti</button>
                    <button type="button" className="btn btn-outline-danger " onClick={() => setDeleteProductData(product)} >Trinti</button>
